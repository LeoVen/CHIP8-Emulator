...
use crate::display::{Chip8Display, DebugDisplay};
...
fn chip_test_instruction_0x5() {
    // 0x5XY0 -> SE VX, VY
    let mut chip = Chip8::<DebugDisplay>::new();
    ...
    // 0x214 LD V0, 0x0B
    let data: Vec<u8> = vec![
        0x60, 0x00, 0x61, 0x00, 0x50, 0x10, 0x60, 0xFF, 0x60, 0x0C, 0x50, 0x10,
        0x61, 0x0A, 0x50, 0x10, 0x60, 0x0A, 0x50, 0x10, 0x50, 0x0B,
    ];
...
fn chip_test_instruction_0x7() {
    ...
    // .. x8 total
    let data: Vec<u8> = vec![
        0x60, 0x00, 0x61, 0x00, 0x70, 0x01, 0x70, 0x01, 0x70, 0x01, 0x70, 0x01,
...
//     let mut chip = Chip8::<Chip8Display>::new();
